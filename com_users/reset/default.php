...
<div class="reset<?php echo $this->pageclass_sfx?>">
	...
	<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=reset.request'); ?>" method="post" class="form-validate">
		...
		<div class="input-group col-xs-3">
			...
			<input type="text" name="jform[email]" id="jform_email" value="" class="form-control validate-username required" size="30" required aria-required="true" placeholder="<?php echo str_replace(":", "", JText::_('COM_USERS_REGISTER_EMAIL1_LABEL')); ?>" />
		</div>
